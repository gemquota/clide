...
TECHNICAL DEEP-DIVE:
The 'design' command is the 'Architectural Layer' of the Forge.
1. Drafting: Uses the LLM to expand a one-line prompt into a multi-page spec.
2. Structure: Includes 'Function Signatures', 'Data Flow', and 'External PyPI Requirements'.
3. Verification: Adheres to the 'agents.md' behavioral constitution.
