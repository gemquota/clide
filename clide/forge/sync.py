...
INDEX_FILE = "/data/data/com.termux/files/home/openclaw/meta/swarm/commands/commands_index.md"
...
def sync():
    ...
    with open(INDEX_FILE, "w") as f:
        ...
        f.write("*   **[extractor.py](../clide/extractor.py)**: The core monitoring service.\n\n")
