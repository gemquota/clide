...
BASE_DIR = "/data/data/com.termux/files/home/meta/swarm/new/plugins"
ROOT_MD_DIR = "/data/data/com.termux/files/home/meta/swarm/new"
...
def ingest_agent(plugin_name, agent_file):
    ...
    registry_metadata = {
        ...
        "name": agent_id,
        "description": desc,
        "path": agent_file.replace("/data/data/com.termux/files/home/meta/", "")
    }
...
def ingest_command(plugin_name, command_file):
    ...
    registry_metadata = {
        ...
        "name": cmd_id,
        "description": desc,
        "path": command_file.replace("/data/data/com.termux/files/home/meta/", "")
    }
...
def ingest_skill(plugin_name, skill_dir):
    ...
    registry_metadata = {
        ...
        "name": skill_id,
        "description": desc,
        "path": skill_file.replace("/data/data/com.termux/files/home/meta/", "")
    }
...
def ingest_general_md(file_path, category="general"):
    ...
    registry_metadata = {
        ...
        "name": file_name,
        "description": desc,
        "path": file_path.replace("/data/data/com.termux/files/home/meta/", "")
    }
